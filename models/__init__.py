...
from .token_adapter import TokenAdapterViTL16, TokenAdapterViTH14
...
def token_adapter_vit_l16_in1k(pretrained: bool = False, progress: bool = True, **kwargs):
    return build_model(
        TokenAdapterViTL16,
        ModelCheckpoints.vit_l16_in1k.value,
        # image_size=512,
...
def token_adapter_vit_h14_in1k(pretrained: bool = True, progress: bool = True, **kwargs):
    return build_model(
        TokenAdapterViTH14,
        ModelCheckpoints.vit_h14_in1k.value,
        # image_size=518,
